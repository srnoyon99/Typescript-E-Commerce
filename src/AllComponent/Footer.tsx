import { AppleStore, facebook, instagram, linkedin, PlayStore, Qr, Sent, twitter } from '@/ImportImages/ImportImages';
          ...
          <div>
            ...
            <div className="flex  space-x-2">
              ...
              <div className="flex flex-col space-x-2">
                <a href="#" > <img src={PlayStore} alt=" icon" /></a>
                <a href="#" > <img src={AppleStore} alt=" icon" /></a>
              </div>
            </div>
